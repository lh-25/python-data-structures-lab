...
def combine_foods():
    # your code here
  foods = ('pizza', 'tuna sandwich', 'tacos')
  meal = ''
  for food in foods:
    meal += food
    meal += " "
...
def hometown_info():
  ...
  home_town_message = f"I was born in {home_town['city']}, {home_town['state']} - population of {home_town['population']} million"
